...
* [AppointMe](https://github.com/bravodev-hub/appointme) - A production-grade SaaS starter template. .NET 10, React, modular monolith, vertical slices, multitenancy, CQRS, DDD, event-driven architecture, durable messaging (outbox).
